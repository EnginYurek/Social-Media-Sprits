...
public class EnglishChannelParser extends DefaultHandler {
	...
	static final String englishChannelURL="http://gdata.youtube.com/feeds/base/users/thatsophiakid/uploads?alt=rss&v=2&orderby=published&client=ytapi-youtube-profile";
...
Boolean currTag = false;
	...
	public EnglishChannelParser(Context c){
		context=c;
	}
	public void get(){
		try{
			...
			InputStream myInputStream = new URL(englishChannelURL).openStream();
