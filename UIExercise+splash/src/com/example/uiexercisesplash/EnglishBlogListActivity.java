...
public class EnglishBlogListActivity extends ListActivity {
	...
	class PostAsync extends AsyncTask<Void, Void,String[][]>{
		...
		protected void onPreExecute() {
			...
			pd = ProgressDialog.show(EnglishBlogListActivity.this,"Classisinternal","Loading last post...",true,false);	
		...
		protected void onPostExecute(String[][] result) {
			...
			l=getListView();
			myAdapter adapter = new myAdapter(EnglishBlogListActivity.this, blogPostTitle, blogPostDate);
		...
		protected String[][] doInBackground(Void... params) {
			parser = new ClassIsInternalParser(EnglishBlogListActivity.this, "http://classisinternal.com/feed/");
			parser.get();
